...
\begin{figure}
    \centering
    \includegraphics[width=0.9\textwidth]{images/top_of_slope_reconstruction.png}
...
\begin{figure}
    \centering
    \includegraphics[width=0.9\textwidth]{images/top_of_slope_reconstruction_trajectory.png}
